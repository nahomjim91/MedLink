...
export default function IconCard({ icon, label, onClick, isSelected }) {
  ...
  return (
    ...
    >
      <div
        className={`w-28 h-28 md:w-48 md:h-32 bg-white rounded-xl shadow-md flex items-center justify-center mb-2 ${
          isSelected
        ...
        <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-secondary text-base sm:text-lg truncate">
