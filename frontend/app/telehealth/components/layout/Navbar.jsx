        ...
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          >
            ...
            {user ? (
              ...
              >
                <div onClick={() => logout()}>
                  <div className=" hidden  md:flex items-center border-2 border-primary px-4 py-2 text-sm lg:px-6 lg:py-3 lg:text-base text-primary rounded-xl hover:bg-primary/5 transition-colors">
                    Log out
                  </div>
                </div>
              </motion.div>
            ...
            <div className="flex flex-col justify-center items-center h-full w-full px-4">
              ...
              >
                ...
                {user ? (
                  ...
                  >
                    <div className="flex items-center justify-center border-2 border-primary px-6 py-4 text-lg mb-3 md:mb-0 text-primary rounded-xl hover:bg-primary/5 transition-colors mx-auto max-w-xs cursor-pointer">
                      Log out
                    </div>
                  </motion.div>
                ) : (
