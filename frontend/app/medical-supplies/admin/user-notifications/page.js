...
import {getNotificationIcon , getNotificationColors , formatRelativeTime} from "../../components/ui/notificationUI/NotificationDropdown"
        ...
        {notificationStats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 w-full ">
            <div className="bg-primary/20 p-3 rounded-lg">
              <div className="text-2xl font-bold text-primary">{notificationStats.unreadCount}</div>
              <div className="text-sm text-primary">Unread</div>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="text-2xl font-bold text-gray-600">{notificationStats.totalCount}</div>
              <div className="text-sm text-gray-800">Total</div>
            </div>
            <div className="bg-green-50 p-3 rounded-lg">
              <div className="text-2xl font-bold text-green-600">{notificationStats.byType?.order || 0}</div>
              <div className="text-sm text-green-800">Orders</div>
            </div>
            <div className="bg-yellow-50 p-3 rounded-lg">
              <div className="text-2xl font-bold text-yellow-600">{notificationStats.byType?.reminder || 0}</div>
          ...
          <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
            ...
            {selectedNotifications.length > 0 && (
              <button
                ...
                className="flex items-center gap-1 px-3 py-1 bg-primary/60 text-white rounded text-sm hover:bg-primary/70"
              >
          ...
          filteredNotifications.map((notification) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-3 bg min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="text-right">
                        ...
                        {notification.priority && (
                          <div className="text-xs text-gray-400 capitalize">Priority: {notification.priority}</div>
                        )}
                      </div>
