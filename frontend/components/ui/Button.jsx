...
export function Button({ 
    ...
    if (variant === "fill") {
      if (color === "primary") {
        colorClasses = "bg-primary text-white hover:bg-primary/90 focus:ring-primary/30";
      } else if (color === "secondary") {
        colorClasses = "bg-secondary text-white hover:bg-secondary/90 focus:ring-secondary/30";
      } else if (color === "error") {
        colorClasses = "bg-error text-white hover:bg-error/90 focus:ring-error/30";
      } else {
      ...
      if (color === "primary") {
        colorClasses = "border-primary border-2 text-primary hover:bg-primary/5 focus:ring-primary/30";
      } else if (color === "secondary") {
        colorClasses = "border-secondary border-2 text-secondary hover:bg-secondary/5 focus:ring-secondary/30";
      } else if (color === "error") {
        colorClasses = "border-error border-2 text-error hover:bg-error/5 focus:ring-error/30";
      } else {
        // Custom color
    ...
    return (
      <div className={`flex justify-between gap-4 mt-6 ${className}`}>
        ...
        <Button
          ...
          className={`flex-1 sm:flex-initial ${!showPrevious ? 'ml-auto' : ''}`}
        >
          {nextLabel}
        </Button>
      </div>
